...
const Topbar = ({ title, onLogout }) => {
  ...
  return (
    <div className="bg-white border-b border-gray-200 px-3 sm:px-4 md:px-5 lg:px-6 py-2 sm:py-3 lg:py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 lg:space-x-3">
          ...
          <Button
            ...
            variant="ghost"
            size="sm"
            className="h-6 sm:h-7 md:h-8 lg:h-10 w-6 sm:w-7 md:w-8 lg:w-10 p-0 focus:outline-none focus:ring-2 focus:ring-gray-300 touch-manipulation"
          >
